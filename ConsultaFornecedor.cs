...
namespace Zooka
{
    public partial class ConsultaFornecedor: Form
    {
        ...
        {
            InitializeComponent();
            dtgCliente.DataSource = teste.InsertGeral("fornecedor");
            if (ttt = true)
            {
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            {
                string id = Convert.ToString(dtgCliente.SelectedRows[0].Cells["id_fornecedor"].Value);
                ...
                {
                    teste.ExcluirLinha("fornecedor", "id_fornecedor", id);
                    dtgCliente.Refresh();
